...
#include "../adc_routine/sampling.h"
#include "signal.h"
...
/* Definitions for adcRoutineTask */
osThreadId_t adcRoutineTaskHandle;
const osThreadAttr_t adcRoutineTask_attributes = {
  .name = "adcRoutineTask",
  .stack_size = 128 * 4,
...
int main(void)
{
  ...
  /* creation of adcRoutineTask */
  adcRoutineTaskHandle = osThreadNew(StartADCRoutine, NULL, &adcRoutineTask_attributes);
...
/**
* @brief Function implementing the adcRoutineTask thread.
* @param argument: Not used
* @retval None
*/
